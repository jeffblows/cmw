...
;(function($, window, undefined) {
    ...
    var shouldHover = function() { return !!$('#twitter-hover').height(); };
    $(document).ready(function() {
        ...
        $('<div class="nav-collapse collapse" style="visibility:hidden;position:fixed" id="twitter-hover">.</div>').appendTo('body');
    });
